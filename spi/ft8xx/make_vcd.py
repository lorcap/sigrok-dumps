...
def coproc_cmd (filename):
    ...
    with Ft8xxCoProc(file=open(filename, 'w'), write_addr=0x308000) as ft:
        ...
        ft.cmd_gradienta(0, 0, 0xff00ff00, 160, 0, 0x0000ff00)
        ...
        ft.cmd_text(0, 0, 26, 4096, '%+5.3umV', 1947)
        ft.cmd_text(0, 0, 26, 4096, 'Temp %d%.1d degrees', 68, 0)
        ft.cmd_text(0, 0, 26, 4096, '%s %d times', 0x00102030, 5)
        ft.cmd_setbase(16)
        ...
        ft.cmd_rotatearound(32, 32, 180*65536/360, 65536*1)
        ...
        ft.cmd_logo()
        ft.cmd_flasherase()
        ft.cmd_flashwrite(0x801000, 512)
        ft.cmd_flashread(0x0100, 0x801000, 128)
        ft.cmd_appendf(0x802000, 28)
        ft.cmd_flashupdate(0x801000, 0x2000, 128)
        ft.cmd_flashdetach()
        ft.cmd_flashattach()
        ft.cmd_flashfast()
        ft.cmd_flashspidesel()
        ft.cmd_flashspitx(1)
        ft.cmd_flashspirx(100, 3)
        ft.cmd_clearcache()
        ft.cmd_flashsource(0x2200)
        ft.cmd_videostartf()
        ft.cmd_animstart(1, 0x802000, 1)
        ft.cmd_animstop(1)
        ft.cmd_animxy(1, 100, 100)
        ft.cmd_animdraw(1)
        ft.cmd_animframe(0, 400, 4096, 65)
        ft.cmd_sync()
        ft.cmd_bitmap_transform(32, 0, 64, 32, 32, 64, 0, 0, 0, 64, 64, 64, 0)
